...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
  ...
  $sidebar_layout_config = indutri_get_option('woo_sidebar_config', '');
  $left_sidebar = indutri_get_option('woo_left_sidebar', '');
  $right_sidebar = indutri_get_option('woo_right_sidebar', '');
         ...
         <div class="content-page <?php echo esc_attr($main_content_config['class']); ?>">      
                  ...
                  <div class="shop-loop-container">
                    <div class="gvawooaf-before-products layout-grid">
                      ...
                      <?php do_action('indutri_woocommerce_active_filter' );  ?>
